...
os.chdir('C:\\Users\\Orhan\\Documents\\GitHub\\Tree-Net')
# pretrained=False
...
# # Read each TIFF image
# train_loader = get_loader(opt.train_path+inp_path, opt.train_path+inp_path, batchsize=opt.batchsize, trainsize=opt.trainsize, args=opt
#                           augmentation=opt.augmentation)
# test_loader=get_loader(opt.test_path+'test/{}'.format(inp_path), opt.test_path+'test/{}'.format(inp_path), batchsize=1, trainsize=opt.trainsize, args=opt
#                           augmentation=False) # CVC-ClinicDB
# valid_loader=get_loader( opt.test_path+'valid/{}'.format(inp_path), opt.test_path+'valid/{}'.format(inp_path), batchsize=opt.batchsize, trainsize=opt.trainsize, args=opt
#                           augmentation=opt.augmentation)
